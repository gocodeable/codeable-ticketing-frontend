...
export default function IssuesTable({ 
  ...
  const hasActiveFilters = searchQuery.trim() !== "" || priorityFilter !== "all" || statusFilter !== "all" || assigneeFilter.length > 0;
      ...
      {filteredIssues.length === 0 ? (
        ...
        <TableHeader>
          <TableRow className="bg-linear-to-r from-muted/40 via-muted/30 to-muted/40 border-b border-border/40 dark:border-border/60 hover:bg-linear-to-r hover:from-muted/40 hover:via-muted/30 hover:to-muted/40">
            <TableHead className="w-[110px] font-semibold text-foreground/80 h-12 pl-4">Code</TableHead>
            <TableHead className="w-[200px] font-semibold text-foreground/80">Title</TableHead>
            ...
            <TableHead className="w-[170px] font-semibold text-foreground/80 pr-4">Reporter</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
              ...
              >
                ...
                <TableCell className="py-4">
                  <span className={cn(
                    ...
                    getStatusColor(getStatusObject(issue, statuses)?.color)
                  )}>
