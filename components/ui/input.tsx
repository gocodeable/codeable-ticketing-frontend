  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-ring focus-visible:ring-[3px] dark:focus-visible:border-primary/80 dark:focus-visible:shadow-[0_0_20px_rgba(240,250,255,0.5)]",
